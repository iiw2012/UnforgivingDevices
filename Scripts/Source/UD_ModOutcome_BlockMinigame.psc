...
Function Outcome(UD_Modifier_Combo akModifier, UD_CustomDevice_RenderScript akDevice, String asDataStr, Form akForm2, Form akForm3)
    String loc_init     = GetParamStr(akModifier, akDevice, asDataStr, 0, "B")
    Float loc_duration  = GetParamFlt(akModifier, akDevice, asDataStr, 1, 0.0, "Output")
    Bool loc_repeat     = GetParamBln(akModifier, akDevice, asDataStr, 2, False)
    String loc_state    = GetParamStr(akModifier, akDevice, asDataStr, 3, "")
    Float loc_ts        = GetParamFlt(akModifier, akDevice, asDataStr, 4, 0.0)
