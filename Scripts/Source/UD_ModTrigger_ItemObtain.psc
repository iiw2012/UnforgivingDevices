...
Bool Function ItemAdded(UD_Modifier_Combo akModifier, UD_CustomDevice_RenderScript akDevice, Form akItemForm, Int aiItemCount, ObjectReference akSourceContainer, Bool abIsStolen, String asDataStr, Form akForm1)
    ...
    Int loc_min_count       = GetParamInt(akModifier, akDevice, asDataStr, 0, 1,      "Input")
    Float loc_prob1         = GetParamFlt(akModifier, akDevice, asDataStr, 1, 100.0,  "Probability")
    Float loc_prob2         = GetParamFlt(akModifier, akDevice, asDataStr, 2, 0.0,    "Probability")
    Float loc_period        = GetParamFlt(akModifier, akDevice, asDataStr, 3, -1.0,   "-Input")
    Bool loc_stolen         = GetParamBln(akModifier, akDevice, asDataStr, 4, False)
    Int loc_acc             = GetParamInt(akModifier, akDevice, asDataStr, 5, 0)
    Float loc_last          = GetParamFlt(akModifier, akDevice, asDataStr, 6, 0.0)
