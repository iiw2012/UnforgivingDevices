...
Function SetParamInt(UD_CustomDevice_RenderScript akDevice, Int aiPos, Int aiNewValue)
    akDevice.editStringModifier(NameAlias, aiPos, aiNewValue As String)
EndFunction
...
Function SetParamStr(UD_CustomDevice_RenderScript akDevice, Int aiPos, String asNewValue)
    akDevice.editStringModifier(NameAlias, aiPos, asNewValue)
EndFunction

Function SetParamBln(UD_CustomDevice_RenderScript akDevice, Int aiPos, Bool abNewValue)
    If abNewValue
...
Function MinigameEnded(UD_CustomDevice_RenderScript akModDevice, UD_CustomDevice_RenderScript akMinigameDevice, String asDataStr, Form akForm1, Form akForm2, Form akForm3, Form akForm4, Form akForm5)
EndFunction

Function MinigameEndedAsync(UD_CustomDevice_RenderScript akModDevice, UD_CustomDevice_RenderScript akMinigameDevice, String asMinigameName, String asDataStr, Form akForm1, Form akForm2, Form akForm3, Form akForm4, Form akForm5)
EndFunction
...
String Function GetDetails(UD_CustomDevice_RenderScript akDevice, String asDataStr, Form akForm1, Form akForm2, Form akForm3, Form akForm4, Form akForm5)
    ...
    loc_res += GetParamsTableRows(akDevice, asDataStr, akForm1, akForm2, akForm3, akForm4, akForm5)
